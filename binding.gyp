  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "src/binding/ReadStat/src/stata/readstat_dta.c",
        "src/binding/ReadStat/src/stata/readstat_dta_read.c",
        "src/binding/ReadStat/src/stata/readstat_dta_write.c",
        "src/binding/ReadStat/src/stata/readstat_dta_parse_timestamp.c",
        "src/binding/ReadStat/src/spss/readstat_por.c",
        "src/binding/ReadStat/src/spss/readstat_por_parse.c",
        "src/binding/ReadStat/src/spss/readstat_por_read.c",
        "src/binding/ReadStat/src/spss/readstat_por_write.c",
        "src/binding/ReadStat/src/spss/readstat_sav.c",
        "src/binding/ReadStat/src/spss/readstat_sav_compress.c",
        "src/binding/ReadStat/src/spss/readstat_sav_parse.c",
        "src/binding/ReadStat/src/spss/readstat_sav_parse_mr_name.c",
        "src/binding/ReadStat/src/spss/readstat_sav_parse_timestamp.c",
        "src/binding/ReadStat/src/spss/readstat_sav_read.c",
        "src/binding/ReadStat/src/spss/readstat_sav_write.c",
        "src/binding/ReadStat/src/spss/readstat_spss.c",
        "src/binding/ReadStat/src/spss/readstat_spss_parse.c",
        "src/binding/ReadStat/src/spss/readstat_zsav_compress.c",
        "src/binding/ReadStat/src/spss/readstat_zsav_read.c",
        "src/binding/ReadStat/src/spss/readstat_zsav_write.c",
